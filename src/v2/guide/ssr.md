...
The [Factor Platform](https://factor.dev) is a server-rendered, full-stack platform for Vue apps that need CMS and eCommerce functionality. In additional to server-rendered content, you can also use the active server to power dynamic functionality associated with endpoints for example auth, form-handling, image handling, etc.. 
